...
def StylishRegister(request):
    if request.method == 'POST':
        ...
        if Stylish_details.objects.filter(Username=Username).exists():
            ...
            print(name)
            img_name = "C:/Users/Admin/python37/Image forgery detection/media/img/images/" + books_image
            img_name=img_name
            img_name=img_name
            print(img_name)
            ...
            print(name)
            img_names = "C:/Users/Admin/python37/Image forgery detection/media/img/images/" + books_images
            img_names=img_names
            img_names=img_names
            print(img_names)
            ...
            books_image = "C:Users/Admin/python37/Image forgery detection/media/img/images/" + books_image
            books_images = "C:/Users/Admin/python37/Image forgery detection/Image forgery detection/media/img/images/" + books_images
